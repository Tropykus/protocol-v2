...
export const CommonsConfig: ICommonConfiguration = {
  MarketId: 'Commons',
  ATokenNamePrefix: 'Tropykus interest bearing',
  StableDebtTokenNamePrefix: 'Tropykus stable debt bearing',
  VariableDebtTokenNamePrefix: 'Tropykus variable debt bearing',
  SymbolPrefix: '',
  ...
  ProtocolGlobalParams: {
    ...
    MockUsdPriceInWei: '666666666666666', // 1ETH = 1500 USD
